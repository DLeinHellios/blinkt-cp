...
class Panels:
    ...
    def __init__(self, master):
        self.settingsFrame = Frame(padx = 10, pady = 5)
        self.menuFrame = Frame(padx = 10)
        self.pixelFrame = Frame(padx = 10, pady = 5)
        self.place()
    ...
    def place(self):
        ...
        self.pixelFrame.grid(row = 1, column = 1, rowspan = 2, sticky = N)


class Settings:
    '''Displays Red, Green, Blue, and Brightness sliders'''
    def __init__(self, master):
        self.red = Scale(master, from_=0, to=255, length = 300, fg = 'red', orient=HORIZONTAL)
        self.green = Scale(master, from_=0, to=255, length = 300, fg = 'green', orient=HORIZONTAL)
        self.blue = Scale(master, from_=0, to=255, length = 300, fg = 'blue', orient=HORIZONTAL)
        self.bright = Scale(master, from_=0, to=1.0, length = 300, resolution = .1, orient=HORIZONTAL)
    ...
    def place(self):
        # Labels
        self.labelRed.grid(row = 1, column = 1, sticky = N)
        self.labelGreen.grid(row = 2, column = 1, sticky = N)
        self.labelBlue.grid(row = 3, column = 1, sticky = N)
        self.labelBright.grid(row = 4, column = 1, sticky = N)

        # Sliders
        self.red.grid(row = 1, column = 2)
        self.green.grid(row = 2, column = 2)
        self.blue.grid(row = 3, column = 2)
        self.bright.grid(row = 4, column = 2)
